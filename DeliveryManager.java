...
public class DeliveryManager {
    ...
    public void readFileAndSetSneakersDeliveryMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("src/mission/OrderSneakersV2/nike-sneaker-delivery-infos.txt"))) {
    ...
    public void writeTodayDeliveryClip() {
        String filename = "src/mission/OrderSneakersV2/delivery-manager-record.txt"; // 출력할 파일의 이름
    ...
    public void writeTodaySales() {
        String filename = "src/mission/OrderSneakersV2/today-sales.txt"; // 출력할 파일의 이름
