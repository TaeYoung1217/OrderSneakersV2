    ...
    public static void main(String[] args) {
        ...
        while (scanner.hasNext()) {
            ...
            try {
                ...
                Long cash = Long.parseLong(responseArray[3]);
                String sneakerModelName = responseArray[4];

                Customer customer = null;
                switch (customerLevel) {
                    case VIP:
                        customer = new VIPCustomer(customerName, cash, sneakerModelName, isCustomerLikeDelivery);
                        break;
                    case GOLD:
                        customer = new GoldCustomer(customerName, cash, sneakerModelName, isCustomerLikeDelivery);
                        break;
                    case SILVER:
                        customer = new SilverCustomer(customerName, cash, sneakerModelName, isCustomerLikeDelivery);
                        break;
                }
