...
public class Staff {
    ...
    public void readFileAndSetSneakerInfoMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("src/mission/OrderSneakersV2/nike-sneaker-characters.txt"))) {
    ...
    public void readFileAndSetSneakersStockMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("src/mission/OrderSneakersV2/nike-sneaker-stocks.txt"))) {
    ...
    public void writeTodaySalesClip() {
        String filename = "src/mission/OrderSneakersV2/staff-sales.txt"; // 출력할 파일의 이름
    ...
    public void writeTodaySales() {
        String filename = "src/mission/OrderSneakersV2/today-sales.txt";
    ...
    public void writeTodayStocks() {
        String filename = "src/mission/OrderSneakersV2/nike-sneaker-stocks-2.txt";
