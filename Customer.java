...
public abstract class Customer {
    ...
    public Customer(String customerName, Long cash, String sneakerModel, Boolean likeDelivery) {
    ...
    public void wearSneakers(Sneakers nikeSneakers) {
        ...
        System.out.printf("손님: 이 신발은 %s 의 특징이 느껴지네요, 기분이 %s 이고, 잔액 %d 남았습니다.\n", nikeSneakers.getSneakersInfo().getFeature(), this.myFeeling, this.cash);
    }
